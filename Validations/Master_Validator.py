...
if __name__ == "__main__":
    example_file = "../Examples/Example CSV for Max - Sheet1.csv" ##Change to path of new file from max with new data
    master_file = "Master_Collector(newmain).csv"
    ...
    print(f"Validation completed. Results saved to {primary_output_file} and {secondary_output_file}")