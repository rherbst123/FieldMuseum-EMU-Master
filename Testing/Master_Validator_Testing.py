...
# Input files
EXAMPLE_FILE = '../Examples/Example_MAX_Sheet.csv'  # New data from Max
MASTER_FILE = '/home/riley/Documents/GitHub/FieldMuseum-EMU-Master/Validations/Master_Collector(newmain).csv'  # Master collector database
