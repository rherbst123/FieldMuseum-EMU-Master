...
def create_modified_max_sheet(example_file, primary_results_file, secondary_results_file, master_file, output_file):
    ...
    for i in range(2, 6):
        new_cols.extend([f'secondary_{i}_master_irn', f'HUH_BotanistID_{i}', f'HUH_GUID_{i}', f'collectorName{i}', f'verbatimCollector{i}', f'secondary_{i}_master_name', f'secondary_{i}_score'])
...
if __name__ == "__main__":
    ...
    create_modified_max_sheet(EXAMPLE_FILE, PRIMARY_OUTPUT_FILE, SECONDARY_OUTPUT_FILE, MASTER_FILE, MODIFIED_MAX_SHEET)
